...
| --- | --- | --- |
| `funny` | 650 | Cosmic shrugs, office earnestness, gentle nagging about water |
| `sincere` | 102 | Straightforward encouragement, no jokes |
| `cosmic` | 147 | Entropy, the multiverse, the cheerful kind of nihilism |
| `office` | 190 | Workplace enthusiasm, deadpan asides, beet-farm discipline |
